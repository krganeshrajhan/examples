package example.java.design.patterns.principles.structural.decorator;

import java.util.function.Supplier;

class StaticDecoratorDemo {
    public static void main(String[] args) {
        CircleStatic circle = new CircleStatic(10);
        ...
        // ugly!
        TransparentShapeStatic<ColoredShapeStatic<CircleStatic>> myCircle =
